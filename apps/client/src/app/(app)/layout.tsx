			...
			<div className="flex overflow-hidden">
				<aside className="flex w-56 shrink-0 flex-col border-r bg-muted/20">
					<div className="flex flex-1 flex-col gap-1 p-3">
						<p className="mb-4 px-3 font-mono text-[10px] font-semibold tracking-[0.1em] text-muted-foreground uppercase opacity-50">
							[Multi-Channel Ops]
						</p>
						{NAV.map((n) => (
							<Link
					...
					<div className="border-t p-4 font-mono text-[10.5px] text-muted-foreground opacity-60">
						...
						<div className="mt-1 flex items-center gap-2">
							env: <span className="text-primary font-medium">production</span>
							<PulseDot size={4} />
						</div>
					</div>
				</aside>
